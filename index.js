...
var SSPInstance = Class.extend({
  ...
  initialize: function (opts) {
    ...
    this.port = new serialport.SerialPort(options.device, {
    ...
    this.commands = new Commands(this.port, options.type, options.sspID, options.sequence);
  },
  enable: function (cb) {
  ...
  init: function (enableOnInit, cb) {
    ...
    port.isOpened && port.close(function () {
      port.isOpened = false;
    });
